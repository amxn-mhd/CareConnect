...
import { ReportHistoryComponent } from './Pages/safety/report-history/report-history.component';
import { UserComponent } from './Pages/LandAndAuth/user/user.component';
import { MoodAnalyserComponent } from './Pages/mental-health/mood-analyser/mood-analyser.component';
import { authGuard } from './Pages/ApiServices/Gaurds/authgaurd.guard';
...
export const routes: Routes = [
  ...
  {path:'user',component:UserComponent},
     {path:'mood-analyser',component:MoodAnalyserComponent},
